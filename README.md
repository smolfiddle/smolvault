...
| Metric | Result |
|---|---|
| PUT 700 MB into the constrained server | 201 · **46 MB/s** |
| GET full + sha256 verify | byte-exact |
| Seek p50/p95 | 17 ms / 36 ms |
| Server peak memory | **763 MB of 1024** (incl. reclaimable mmap cache) |
...
| Promise | Measured |
|---|---|
| **CDC survives edits** — insert 1 MB mid-file into 192 MB, re-seal | **~89–98% deduped** · effective write speed *exceeds* naive copy |
